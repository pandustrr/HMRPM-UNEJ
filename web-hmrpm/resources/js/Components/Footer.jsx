                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-2">
                            <Link href="/about" className="text-muted-foreground hover:text-brand-yellow text-sm transition-colors">About Us</Link>
                            <Link href="/divisi" className="text-muted-foreground hover:text-brand-yellow text-sm transition-colors">Struktur Organisasi</Link>
                            <Link href="/proker" className="text-muted-foreground hover:text-brand-yellow text-sm transition-colors">Program Kerja</Link>
                            <Link href="/blog" className="text-muted-foreground hover:text-brand-yellow text-sm transition-colors">Blog & Berita</Link>
                        </div>
                    </div>
