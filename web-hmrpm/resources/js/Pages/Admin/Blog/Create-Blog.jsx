            ...
            <div className="p-6 max-w-6xl mx-auto space-y-6">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-black text-foreground uppercase tracking-tighter">BUAT BLOG BARU</h1>
                            <p className="text-muted-foreground text-xs font-medium">Tulis artikel atau berita terbaru untuk HMRPM.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="space-y-6">
                        ...
                        >
                            <span className="relative z-10 flex items-center gap-2 leading-none">
                                <Save size={20} />
                                {processing ? 'MENYIMPAN...' : 'SIMPAN BLOG'}
                            </span>
                        </button>
                    </div>
                </form>
