...
const HomeIndex = ({ settings }) => {
    ...
    return (
        <>
            <Head title="Background Beranda | HMRPM Admin" />
            <div className="max-w-3xl mx-auto space-y-6">
                <div>
                    <h1 className="text-2xl font-black text-slate-900 tracking-tighter mb-1 uppercase">BACKGROUND BERANDA</h1>
                    <p className="text-slate-500 text-xs font-medium">Kelola tampilan hero background halaman utama/beranda (Video/Gambar/GIF).</p>
                </div>
...
HomeIndex.layout = (page) => <AdminLayout children={page} />;
