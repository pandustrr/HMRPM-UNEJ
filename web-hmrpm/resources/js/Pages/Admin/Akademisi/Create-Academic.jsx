...
const CreateAcademic = () => {
    ...
    return (
        <>
            <Head title="Tambah Dosen/Teknisi | HMRPM Admin" />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-slate-500 text-xs font-medium">Lengkapi data Dosen atau Teknisi baru.</p>
                        </div>
                    </div>
                </div>
...
CreateAcademic.layout = (page) => <AdminLayout children={page} />;
