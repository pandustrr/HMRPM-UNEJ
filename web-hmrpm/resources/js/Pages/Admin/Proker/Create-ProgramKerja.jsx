...
export default function Create({ divisions, selectedDivisionId }) {
        ...
        <>
            ...
            <div className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-foreground">Tambah Program Kerja</h1>
                        <p className="text-muted-foreground mt-1">Buat program kerja baru untuk divisi</p>
                    </div>
                </div>
                    ...
                    <div className="bg-white rounded-2xl border border-border p-6 space-y-6 shadow-sm">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-red/20"
                                placeholder="Contoh: Upgrading Staff"
                            />
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                ...
                                rows={5}
                                className="w-full px-4 py-2.5 border border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-red/20"
                                placeholder="Tuliskan detail kegiatan, tujuan, dan hasil yang dicapai..."
                            />
                        ...
                        {/* Documentation */}
                        <div className="space-y-2">
                            <label className="block text-sm font-medium">Dokumentasi (Foto/Video)</label>
                            <input
                                type="file"
                                multiple
                                accept="image/*,video/*"
                            ...
                            {errors.documentation && <p className="text-red-600 text-sm">{errors.documentation}</p>}
