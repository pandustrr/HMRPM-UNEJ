        ...
        <>
            ...
            <div className="p-6 space-y-6">
                <div className="flex items-center gap-4">
                    <Link
                        href={data.division_id_source ? `/admin/divisions/${data.division_id_source}/edit` : `/admin/divisions?period_id=${data.period_id}&show_all_members=1&member_division_id=${data.filter_division_id}`}
                        ...
                        <div className="bg-white rounded-2xl border border-border p-4 shadow-sm space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className={`group relative h-64 w-full max-w-[160px] mx-auto rounded-3xl overflow-hidden transition-all ${(previewUrl || member.photo) ? 'bg-card border border-border shadow-md' : 'bg-muted/5 border-2 border-dashed border-border hover:border-brand-red/50'}`}>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className={`group relative h-64 w-full max-w-[160px] mx-auto rounded-3xl overflow-hidden transition-all ${(data.video || member.video) ? 'bg-card border border-border shadow-md' : 'bg-muted/5 border-2 border-dashed border-border hover:border-brand-red/50'}`}>
