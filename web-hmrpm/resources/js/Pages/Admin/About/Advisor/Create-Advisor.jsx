...
const CreateAdvisor = () => {
    ...
    return (
        <>
            <Head title="Tambah Pembina/Pendamping | HMRPM Admin" />
            <div className="max-w-4xl mx-auto space-y-6 pb-12 text-sm">
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-2xl font-black text-slate-900 tracking-tighter uppercase">Tambah Data</h1>
                            <p className="text-slate-500 text-xs font-medium">Lengkapi data Pembina atau Pendamping baru.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white rounded-4xl border border-slate-200 p-6 shadow-sm space-y-5">
                            ...
                            <div className="space-y-3 pt-4 border-t border-slate-100">
                                ...
                                <p className="text-[9px] text-slate-400 text-center font-medium uppercase tracking-tight">MP4 (Maks. 10MB)</p>
                                ...
                                <div className="space-y-4">
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            className="w-full bg-slate-50 border border-slate-100 rounded-xl p-4 font-medium text-slate-700 focus:border-brand-red outline-hidden transition-all text-xs"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <textarea
                                            ...
                                            rows="2"
                                            className="w-full bg-slate-50 border border-slate-100 rounded-xl p-4 font-medium text-slate-700 focus:border-brand-yellow outline-hidden transition-all text-xs"
...
CreateAdvisor.layout = (page) => <AdminLayout children={page} />;
